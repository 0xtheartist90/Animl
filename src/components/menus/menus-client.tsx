                ...
                {TABS.map((tab) => {
                    ...
                    return (
                        <button
                            ...
                            <span className='label-mono text-[12px] md:text-[12px]'>{tab.label}</span>
                            {isActive && (
                                <motion.span
                        ...
                        <div className='scroll-invisible -mx-1 flex shrink-0 gap-1 overflow-x-auto pb-2'>
                            {activeTab.courses.map((course) => (
                                <button
                                    ...
                                    className={`label-mono shrink-0 px-3 py-2 text-[12px] transition-colors duration-300 ${
                    ...
                    <AnimatePresence mode='wait' initial={false}>
                        <motion.div
                            ...
                            <div className='flex shrink-0 items-baseline justify-between gap-6'>
                                ...
                                {activeCourse.note && (
                                    <p className='label-mono text-smoke hidden max-w-xs text-right text-[12px] leading-relaxed md:block'>
                                        {activeCourse.note}
                                    </p>
                                )}
                            </div>
